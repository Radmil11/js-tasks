...
[
  ...
  const answer2 = data.reduce((acc, curr) => [...acc, curr.email], [])
  console.log({answer2})
  ...
  const answer8 = data.reduce((acc, curr) => [...acc, curr.website.includes('.com') ? curr : null], []
  ).filter(el => Boolean(el))
  console.log({answer8})

  const answer9 = data.reduce(
    (acc, curr) => [...acc, curr.username.length > 12 ? curr : null], []
  ).filter(el => Boolean(el))
  console.log({answer9})
